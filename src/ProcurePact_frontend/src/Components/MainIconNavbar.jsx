...
import "../styles/MainIconNavbarStyles.css";

const MainIconNavbar = () => {
  ...
  return (
    <div className="icon-navbar">
      ...
      <div className="auth-section" onClick={isAuthenticated ? logout : login}>
        ...
        {/* <span className="tooltip-text">{isAuthenticated ? "Logout" : "Login"}</span> */}
      </div>
    </div>
  );
};

export default MainIconNavbar;